...
const ListPanel = observer(() => {
  ...
  function filterMovie(movie, filters, active) {
    ...
    if (filters.type !== "any" && movie.media_type !== filters.type)
      return false
  ...
  useEffect(() => {
    ...
    const filteredMovies = dashboardStore.listDetails.movies.filter((movie) =>
      filterMovie(
        movie,
        dashboardStore.appliedListFilters,
        ...
        <>
          <div className={styles["header"]}>
            <div className={styles["list-heading"]}>
              ...
              {!(
                dashboardStore.listDetails?.listId ===
                  dashboardStore.user?.fav_lid ||
                dashboardStore.listDetails?.listId ===
                  dashboardStore.user?.watch_lid
              ) && (
